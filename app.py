...
st.title("🖼️ Ludy 1.1 – Lightweight AI Image Generator")
st.markdown("""
This is **Ludy 1.1** – a simple, fast image generator using Mini-DALL-E (no heavy downloads, works on CPU).  
...
First generation may take 10–30 seconds while model loads.
""")
